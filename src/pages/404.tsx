...
const x = [30, 10, -30, 30, 0];
const y = [-30, -10, 30, -39, 0];
const scale = [0.5, 0.8, 1.2, 2, 1.2];
const rotate = [10, -10, 10, -10, 0];
const opacity = [0, 1, 0, 0.5, 1];
      ...
      <LostCover>
        ...
        <div style={{ overflow: "hidden" }}>
          <motion.div
            initial={{ y: 250 }}
            animate={{ y: 0 }}
            transition={{ duration: 2, delay: 2, easing: "easeOut" }}
          >
            <StyledLink to="/">
              <Img fluid={logo} style={{ width: "300px" }} />
            </StyledLink>
          </motion.div>
        </div>
      </LostCover>
